...
Pages.prototype.fetch = function (pagen = 0, prefix = '', contentOnly = false) {

  return new Promiserr(function (resolve, reject) {
    gitmech.logBulk(/\.md$/, resolve);
    ...
    return new Promiserr(function (resolve, reject) {
      ...
      const pages = Object.values(filesMetadata)
      ...
      for (const data of slice) {
        ...
        if (contentOnly) {
          Promisers.push(page.fetchContent())
        } else {
          page.metadata = filesMetadata[filename];
